...
float HexBoard::getScrollX() const { return baseScrollX; }
float HexBoard::getScrollY() const { return baseScrollY; }
...
bool HexBoard::handleClick(const sf::Event::MouseButtonEvent &event,
