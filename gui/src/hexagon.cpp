...
void Hexagon::draw(sf::RenderTarget &renderTarget) {
  renderTarget.draw(hex);
  renderTarget.draw(text);
}
bool Hexagon::isMouseEventInInterior(const sf::Event::MouseButtonEvent &event) {
...
float Hexagon::getBaseSize() { return hexBaseSize; }

float Hexagon::getRowHeight() { return hexRowSize; }
